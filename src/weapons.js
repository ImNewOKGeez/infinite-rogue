...
export const ASCENSION_TIER_DEFS = {
  ...
  proximity_mine: {
    ...
    tiers: {
      ...
      2: { maxMines: 6, triggerRadius: 18, blastRadius: 120, damageMult: 3.0, scatterMineCount: 6, scatterMineTriggerRadius: 12, scatterMineBlastRadius: 72, scatterMineDamageMult: 0.45, scatterMineTravelTimeMin: 0.42, scatterMineTravelTimeMax: 0.7, scatterMineArmTimer: 0.18, scatterMineSpeedMin: 360, scatterMineSpeedMax: 620, description: 'When a mine explodes, it launches 6 smaller mines far outward at random angles.' },
      3: { maxMines: 6, triggerRadius: 18, blastRadius: 145, damageMult: 3.0, scatterMineCount: 6, scatterMineTriggerRadius: 12, scatterMineBlastRadius: 72, scatterMineDamageMult: 0.45, scatterMineTravelTimeMin: 0.42, scatterMineTravelTimeMax: 0.7, scatterMineArmTimer: 0.18, scatterMineSpeedMin: 360, scatterMineSpeedMax: 620, description: 'The main proximity mine blast radius increases.' },
      4: { maxMines: 6, triggerRadius: 18, blastRadius: 145, damageMult: 3.0, scatterMineCount: 10, scatterMineTriggerRadius: 12, scatterMineBlastRadius: 72, scatterMineDamageMult: 0.45, scatterMineTravelTimeMin: 0.42, scatterMineTravelTimeMax: 0.7, scatterMineArmTimer: 0.18, scatterMineSpeedMin: 360, scatterMineSpeedMax: 620, description: 'More smaller mines fly out from each triggered mine.' },
      5: { maxMines: 6, triggerRadius: 18, blastRadius: 170, damageMult: 3.0, scatterMineCount: 10, scatterMineTriggerRadius: 12, scatterMineBlastRadius: 72, scatterMineDamageMult: 0.45, scatterMineTravelTimeMin: 0.42, scatterMineTravelTimeMax: 0.7, scatterMineArmTimer: 0.18, scatterMineSpeedMin: 360, scatterMineSpeedMax: 620, description: 'The main proximity mine blast radius increases again.' },
    },
  },
  fragmentation: {
    weaponId: 'pulse',
    ...
    fire(p) {
      ...
      if (ascension === 'proximity_mine') {
        ...
        p._pulseMines.push({
          ...
          scatterMineTravelTimeMin: mineDef?.scatterMineTravelTimeMin || 0.42,
          scatterMineTravelTimeMax: mineDef?.scatterMineTravelTimeMax || 0.7,
          scatterMineArmTimer: mineDef?.scatterMineArmTimer || 0.18,
          scatterMineSpeedMin: mineDef?.scatterMineSpeedMin || 360,
          scatterMineSpeedMax: mineDef?.scatterMineSpeedMax || 620,
          isScatterMine: false,
          spawnClusters: true,
          spawnSlowField: true,
        });
