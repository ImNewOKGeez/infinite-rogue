...
const ASCENSION_TIER_FIELD_FORMATTERS = {
  ...
  impactRadiusScale: { label: 'Hit explosion size', format: value => `${Number(value).toFixed(2)}x` },
  clusterRadiusScale: { label: 'Cluster bomb size', format: value => `${Number(value).toFixed(2)}x` },
